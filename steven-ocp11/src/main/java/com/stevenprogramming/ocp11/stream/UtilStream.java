...
public class UtilStream {
  ...
  public static <T> void printOptional(Optional<T> optional, String description) {
  ...
  public static <T> void printStream(Stream<T> stream, String description) {
    ...
    public static <T> void printStreamSpecial(Stream<T> stream, String description) {
    System.out.println("\n\t\t*****************   printStream  OneLine " + description + " *******************\n");
    stream.forEach(i -> System.out.print(" --Special i= " + i + " END "));
  }
